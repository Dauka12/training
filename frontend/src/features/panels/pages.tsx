        ...
        <div className="stack">
          {(users.data?.items ?? []).map((item) => (
            <article key={item.email} className="notice">
              ...
              <span className="muted">{translateStatus(locale, item.plan_health)}</span>
              <span className="muted">{item.workouts}</span>
              <button type="button" className="button" onClick={() => setSelectedEmail(item.email)}>
        ...
        <>
          <section className="card">
            <div className="section-header">
              ...
              <button type="button" className="button button--primary" onClick={() => regenerate.mutate()}>
          ...
          <section className="card">
            ...
            <div className="button-row">
              <button type="button" className="button button--primary" onClick={() => addNote.mutate()} disabled={!noteBody.trim()}>
    ...
    <>
      ...
      <section className="card">
        ...
        <div className="form-grid">
          <Field label={t(locale, 'admin.userEmail')} value={memberEmail} onChange={setMemberEmail} />
          <Field label={t(locale, 'admin.trainerEmail')} value={trainerEmail} onChange={setTrainerEmail} />
        </div>
        <div className="button-row">
          <button type="button" className="button button--primary" onClick={() => assignTrainer.mutate()}>
      ...
      <section className="card">
        ...
        <div className="button-row">
          <button type="button" className="button button--primary" onClick={() => addEquipment.mutate()}>
      ...
      <section className="card">
        ...
        <div className="button-row">
          <button type="button" className="button button--primary" onClick={() => addExercise.mutate()}>
