...
func (a *App) Routes() http.Handler {
	...
	mux.HandleFunc("/api/v1/auth/change-password", a.withAuth(a.handleChangePassword))
	...
	mux.HandleFunc("/api/v1/catalog/exercises/", a.withAuth(a.handleExerciseCatalogSubroutes))
	...
	mux.HandleFunc("/api/v1/admin/catalog/exercises/", a.withAuth(a.withRoles(a.handleAdminExerciseSubroutes, "admin")))
	mux.HandleFunc("/api/v1/admin/catalog/import/wger/preview", a.withAuth(a.withRoles(a.handleAdminWgerPreview, "admin")))
